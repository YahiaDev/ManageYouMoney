...
module.controller('HomeController', ['HomeService', 'MonthLabel', '$cookieStore', function (HomeService, MonthLabel, $cookieStore) {
    var vm = this;
    vm.purchaseByCateg = {};
    vm.loadedData = false;
    ...
    vm.getPurchaseGroupedByCateg = function () {
        vm.loadedData = false;
        HomeService.getPurchaseGroupedByCateg($cookieStore.get('logedUser').id).then(function (response) {
    ...
    vm.getPurchaseGroupedByDate = function () {
        vm.loadedData = false;
        HomeService.getPurchaseGroupedByDate($cookieStore.get('logedUser').id).then(function (response) {
