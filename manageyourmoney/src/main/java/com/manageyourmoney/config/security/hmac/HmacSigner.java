...
public class HmacSigner {
	...
	/**
	 * Get a signed JWT The issuer (user id) and the custom properties are
	 * stored in the JWT to be retrieve later
	 * 
	 * @param iss
	 ...
	 * @param claims
	 *            Custom properties to store in the JWT
	 * @return HmacToken instance
	 * @throws HmacException
	 */
	public static HmacToken getSignedToken(String secret, String iss, Integer ttl, Map<String, String> claims)
			throws HmacException {
	 ...
	 * @return Signed JWT
	 */
	private static String generateJWT(String secret, String jwtID, String iss, Integer ttl, Map<String, String> claims)
			throws HmacException {
		try {
	 ...
	 */
	public static String signJWT(String secret, String jwtID, Integer ttl, String iss, Map<String, String> claims)
			throws JOSEException {
		JWSSigner jwsSigner = new MACSigner(secret.getBytes());

		// Create a new claim
		JWTClaimsSet.Builder builder = new JWTClaimsSet.Builder();
		builder.jwtID(jwtID).expirationTime(DateTime.now().plusMinutes(ttl).toDate()).issuer(iss);
	 ...
	 *            json web token
	 * @param claimKey
	 *            claim key of the property to retrieve
	 ...
	 *
	 * @param secret
	 *            secret used to sign the message
	 * @param message
	 *            message to sign
	 * @param algorithm
	 *            algorithm ued to sign
	 * @return an HMAC encoded string
	 * @throws HmacException
	 */
	public static String encodeMac(final String secret, final String message, final String algorithm)
			throws HmacException {
		String digest;
		try {
